...
<span className="font-heading text-xl tracking-[0.15em] text-noir-text uppercase">The Black</span>
<span className="font-heading text-xl text-noir-accent italic">Pearch</span>
</Link>
